...
@section('title', 'No Autorizado - MA Piscinas')

@section('page-title', 'Acceso Denegado')
@section('page-subtitle', 'No tienes permisos para acceder a esta sección')
...
<div class="card text-center" style="max-width: 600px; margin: 50px auto;">
    <div class="card-body p-5">
        ...
        <h3 class="text-danger mb-3">No tienes autorización</h3>
        
        <p class="text-muted mb-4">
            Tu cuenta no tiene los permisos necesarios para acceder a la gestión de usuarios. 
            Esta sección está restringida solo para administradores.
        </p>
        
        <div class="alert alert-warning" role="alert">
            <strong>¿Necesitas acceso?</strong><br>
            Por favor, contacta a un administrador del sistema para solicitar permisos de acceso.
        </div>
