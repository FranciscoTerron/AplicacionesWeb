...
<div class="d-flex justify-content-between align-items-center mt-3 flex-wrap gap-2">
    <div class="d-flex align-items-center gap-2">
        @if(($page ?? 1) > 1)
            <a href="{{ route('admin.shipments.index', array_filter([
                'page' => ($page ?? 1) - 1,
                'after' => null,
                'search' => $search ?? null,
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <select class="form-select form-select-sm per-page-select" style="width:auto" data-route="admin.shipments.index">
