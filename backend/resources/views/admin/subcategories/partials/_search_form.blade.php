<form method="GET" action="{{ route('admin.subcategories.index') }}" class="row g-3">
            <div class="col-md-4">
                <input type="text" name="search" class="form-control" placeholder="Buscar por nombre o slug..." value="{{ $search ?? '' }}" aria-label="Buscar por nombre o slug">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2 d-grid">
                ...
                @include('admin.partials._filters', ['routeName' => 'admin.subcategories.index'])
            </div>
        </form>