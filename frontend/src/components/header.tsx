...
export function Header() {
  return (
    <header className="sticky top-0 z-40 bg-brand-yellow text-brand-yellow-foreground shadow-sm">
      <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-2.5 md:flex-row md:items-center md:gap-4">
        ...
        <nav className="flex items-center gap-1">
          <Link
            href="/productos"
            className="rounded-md px-2 py-1.5 text-sm font-medium hover:bg-black/5"
          >
            Productos
          </Link>
          <AccountMenu />
