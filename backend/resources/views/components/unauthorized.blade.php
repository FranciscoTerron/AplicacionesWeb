@props(['title' => 'Acceso Denegado', 'subtitle' => 'No tienes permisos para acceder a esta sección', 'message' => 'Tu cuenta no tiene los permisos necesarios para acceder a esta sección.', 'contactMessage' => 'Por favor, contacta a un administrador del sistema para solicitar permisos de acceso.'])

@extends('layouts.admin')

@section('title', '{{ $title }} - MA Piscinas')
