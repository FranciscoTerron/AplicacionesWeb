...
<head>
    ...
    <title>MA Piscinas — E-commerce de Piscinas e Insumos</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* línea lateral animada al hover */
        .product-card::before {
            content: '';
            position: absolute;
            top: 0; left: 0;
        ...
        footer strong { color: var(--cyan); font-weight: 400; }

        /* ── RIPPLE al click (efecto agua) ─────────────── */
        .ripple {
            position: fixed;
            border-radius: 50%;
            transform: scale(0);
...
<body>
    ...
    <div class="section" style="padding-top: 0">
        ...
        <div class="team-grid">
            <div class="team-card">
                ...
                <div class="team-body">
                    <h3 class="team-name">Francisco Terrón</h3>
            ...
            <div class="team-card">
                ...
                <div class="team-body">
                    <h3 class="team-name">Mauro San Pedro</h3>
                    <p class="team-role">Desarrollador · Aplicaciones Web</p>
                </div>
            </div>
        </div>
    ...
    <footer>
        <p>© 2026 <strong>MA Piscinas</strong> &mdash; Aplicaciones Web &middot; Universidad</p>
    </footer>

    {{-- Efecto agua al hacer click --}}
    <script>
