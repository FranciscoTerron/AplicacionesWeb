...
class SubcategoriesExport implements FromCollection, ShouldAutoSize, WithHeadings, WithStyles
{
    ...
    public function collection()
    {
        ...
        return collect($this->fetchAllDocumentsFast('subcategories'))->map(function ($doc) {
            return [
                $doc['id'] ?? '',
                $doc['name'] ?? '',
                $doc['slug'] ?? '',
    ...
    {
        return ['ID', 'Nombre', 'Slug', 'Categoría ID', 'Descripción', 'Estado', 'Orden', 'Creado', 'Actualizado'];
    }
