...
class DiscountsExport implements FromCollection, ShouldAutoSize, WithHeadings, WithStyles
{
    ...
    public function collection()
    {
        ...
        return collect($this->fetchAllDocumentsFast('discounts'))->map(function ($doc) {
            return [
                $doc['id'] ?? '',
                $doc['name'] ?? '',
                $doc['code'] ?? '',
