...
class CategoriesExport implements FromCollection, ShouldAutoSize, WithHeadings, WithStyles
{
    ...
    public function collection()
    {
        ...
        return collect($this->fetchAllDocumentsFast('categories'))->map(function ($doc) {
            return [
                $doc['id'] ?? '',
                $doc['name'] ?? '',
                $doc['slug'] ?? '',
    ...
    {
        return ['ID', 'Nombre', 'Slug', 'Descripción', 'Estado', 'Orden', 'Creado', 'Actualizado'];
    }
