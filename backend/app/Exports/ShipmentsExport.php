...
class ShipmentsExport implements FromCollection, ShouldAutoSize, WithHeadings, WithStyles
{
    ...
    public function collection()
    {
        ...
        return collect($this->fetchAllDocumentsFast('shipments'))->map(function ($doc) {
            return [
                $doc['id'] ?? '',
                $doc['order_id'] ?? '',
                $doc['tracking_number'] ?? '',
    ...
    {
        return ['ID', 'Orden ID', 'Número de Seguimiento', 'Estado', 'Transportista', 'Creado', 'Actualizado'];
    }
