...
<thead>
             <tr>
                 ...
                 <th>@include('admin.partials._sort_header', ['field' => 'role', 'label' => 'Rol', 'sort' => $sort ?? '', 'order' => $order ?? ''])</th>
                 <th>Estado</th>
...
<script>
    ...
    // Manejar formulario con AJAX para mejor UX
    ...
    // Botones de nuevo usuario (solo admin)
    @if($isAdmin)
